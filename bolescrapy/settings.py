...
DOWNLOADER_MIDDLEWARES = {
    ...
    'bolescrapy.middlewares.RandomUesrAgent': 100,
    'bolescrapy.middlewares.ProxyMiddleware':100,
}
...
ITEM_PIPELINES = {
    ...
    # 'bolescrapy.pipelines.MysqlPipline': 300,
}
import os
...
# 图片储存路径
IMAGES_STORE = os.path.join(file_path, 'images')
